...
<head>
    ...
    <!-- PAGE LEVEL STYLES-->
    <link href="{{asset('assets')}}/admin/assets/css/pages/auth-light.css" rel="stylesheet" />
</head>
...
<div class="content">
    ...
    <form id="login-form" action="{{route('admin_logincheck')}}" method="post">
        @csrf
...
<!-- PAGE LEVEL PLUGINS -->
<script src="{{asset('assets')}}/admin/assets/vendors/jquery-validation/dist/jquery.validate.min.js" type="text/javascript"></script>
<!-- CORE SCRIPTS-->
<script src="{{asset('assets')}}/admin/assets/js/app.js" type="text/javascript"></script>
<!-- PAGE LEVEL SCRIPTS-->
